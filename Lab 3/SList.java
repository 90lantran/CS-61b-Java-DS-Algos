...
public class SList {
  ...
  public void insertEnd(Object obj) {
    if (tail == null) {
      ...
      head = tail;
    } else tail.next = new SListNode(obj);
    size++;
  }
  ...
  public static void main (String[] args) {
    ...
    testAfterInsertEnd();
    System.out.println("Dibakar's EDits");
    SList l = new SList();
    l.insertFront(new Integer(12));
    l.insertFront(new Integer(9));
    l.insertFront(new Integer(6));  
    System.out.println("My first list is" + l.toString());
    l.insertFront(new Integer(3));
    l.insertEnd(new Integer(15));
    System.out.println("My second list is" + l.toString());
  }
